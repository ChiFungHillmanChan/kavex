...
You are the Kavex orchestrator executing Phase 5 for item **{{ITEM_NUMBER}}** of **{{TOTAL_ITEMS}}**.
...
cat .kavex-loop/gates/item-{{ITEM_NUMBER}}-phase-4.gate
```
...
Add this trailer:
  Kavex Team Loop - PRD item {{ITEM_NUMBER}}
