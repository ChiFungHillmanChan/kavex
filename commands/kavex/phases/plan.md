...
You are the Kavex orchestrator executing Phase 1 for item **{{ITEM_NUMBER}}** of **{{TOTAL_ITEMS}}**.
...
Apply the writing-plans skill. Create `.kavex-loop/plans/item-{{ITEM_NUMBER}}-plan.md`:
...
- **Kavex Team Loop** — Phase 2 will read and execute these steps automatically
...
```
Phase 1 done. Plan: N files, M steps. See .kavex-loop/plans/item-N-plan.md
```
