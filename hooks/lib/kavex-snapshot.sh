#!/bin/bash
# kavex-snapshot.sh — Sourceable library for working-tree snapshots
# Source this file: source "$LIB_DIR/kavex-snapshot.sh"
#
# Provides: kavex_snapshot <state_dir>
...
# Usage: kavex_snapshot <state_dir>
kavex_snapshot() {
