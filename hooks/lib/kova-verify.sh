#!/bin/bash
# kova-verify.sh — Sourceable library for running verification
# Source this file: source "$LIB_DIR/kova-verify.sh"
#
# Provides: kova_verify <state_dir>
